...
Before executing PCA, a screeplot is generated. Figure \@ref(fig:pca-risk-screeplot) indicates the variance explanation of each principal component. According to the Kaiser's Rule, principal component of one and two would be selected because they all with a variance greater than 1. Figure \@ref(fig:pca-risk-distance) shows   
